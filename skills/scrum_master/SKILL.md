...
### Aşama 1: Sprint Preparation (Planning)
- [ ] **Definition of Ready (DoR)**: Story'nin sprinte alınabilmesi için net kriterler belirle (INVEST: Independent, Negotiable, Valuable, Estimable, Small, Testable).
- [ ] **Capacity Check**: Tatil, hastalık ve toplantı sürelerini düşerek gerçekçi kapasiteyi hesapla.
- [ ] **Goal Setting**: Sadece "iş listesi" değil, ulaşılabilir bir "Sprint Goal" belirle.

### Aşama 2: Sprint Execution (Daily & Removal)
- [ ] **Blocker Management**: Standup'ta duyulan her engeli anında "Impediment Log"a ekle ve sahiplen.
- [ ] **Burndown Hygiene**: Burndown chart'ın gerçeği yansıttığını kontrol et. "Done" olmayan işleri erken teşhis et.
- [ ] **Scope Protection**: Sprint ortasında gelen yeni işleri "Scope Creep" olarak işaretle ve Product Owner ile müzakere et.

### Aşama 3: Sprint Closing (Review & Retro)
- [ ] **Definition of Done (DoD)**: Sadece kodlanmış değil, test edilmiş ve deploy edilebilir işleri "Bitti" say.
- [ ] **Actionable Retro**: Retrospektiften "daha iyi iletişim kuralım" gibi soyut değil, "her sabah 10:15'te code review saati yapalım" gibi somut aksiyonlar çıkar.
- [ ] **Velocity Tracking**: Takımın ortalama hızını güncelle ve gelecek planlamasında kullan.

### Kontrol Noktaları
| Aşama | Doğrulama |
|-------|-----------|
| 1 | Sprint Goal açık ve herkes tarafından anlaşılmış mı? |
| 2 | Retrospektif aksiyonları bir sonraki sprintte takip ediliyor mu? |
| 3 | Paydaşlar (Stakeholders) Review toplantısına katılıyor mu? |
