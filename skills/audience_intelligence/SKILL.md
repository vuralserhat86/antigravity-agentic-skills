...
- [trend-spotter](../trend-spotter/) - Identify trends relevant to audience
- [niche-researcher](../niche-researcher/) - Deep-dive into specific communities
- [influencer-discovery](../../map/influencer-discovery/) - Find influencers matching criteria
- [fit-scorer](../../map/fit-scorer/) - Score influencer-audience alignment
