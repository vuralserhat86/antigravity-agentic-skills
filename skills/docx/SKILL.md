...
### Aşama 1: Analysis (Read Mode)
- [ ] **Extract**: `pandoc` ile text içeriğini al ve markdown'a çevir.
- [ ] **Inspect**: XML yapısını görmek için `unpack` et.

### Aşama 2: Modification (Write Mode)
- [ ] **Redlining**: Değişiklikleri `track-changes` formatında (<w:ins>, <w:del>) yap.
- [ ] **Consistency**: Unpacked dizin üzerinde script çalıştır, manuel XML editleme.
- [ ] **Pack**: Klasörü tekrar `.docx` haline getir.

### Kontrol Noktaları
| Aşama | Doğrulama |
|-------|-----------|
| 1 | Oluşan docx Word ile hatasız açılıyor mu? |
| 2 | Track changes doğru görünüyor mu (kabul/red et)? |
| 3 | XML validasyonu (schema check) geçiyor mu? |