...
> **Kaynak:** [openpyxl Patterns](https://openpyxl.readthedocs.io/en/stable/usage.html) & [Python Financial Modeling Best Practices](https://pypi.org/project/openpyxl/)

### Aşama 1: Analysis & Pattern Matching
...
| Aşama | Doğrulama |
|-------|-----------|
| 1 | Hardcoded değerler yerine dinamik formüller kullanıldı mı? |
| 2 | Veritabanı (DataFrame) satır numarası ile Excel satır numarası (+1 offset) uyuşuyor mu? |
